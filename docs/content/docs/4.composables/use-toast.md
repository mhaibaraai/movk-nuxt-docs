  ...
  A partial `Toast` object with the following properties:
    ...
    :::collapsible
      ::field-group
        ...
        The avatar displayed in the toast. See [Avatar](https://ui.nuxt.com/docs/components/avatar#props).
        ::
        ...
        The actions displayed in the toast. See [Button](https://ui.nuxt.com/docs/components/button#props).
        ::
        ...
        The duration in milliseconds before the toast auto-closes. Can also be set globally on the [`App`](https://ui.nuxt.com/docs/components/app) component.
        ::
