...
seo:
  description: Movk Nuxt Docs 内置 AI Chat，通过 MCP Server 访问文档内容，支持 Anthropic、OpenAI、DeepSeek、Google 等多种模型，配置 AI_GATEWAY_API_KEY 环境变量即可启用。
category: ai
---
...
- [配置文档站点 - AI Chat 配置](/docs/getting-started/configuration#ai-chat-配置)
- [Agent Skills](/docs/getting-started/skills)
