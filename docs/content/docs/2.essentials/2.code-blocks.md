---
title: 代码块
description: 学习如何在您的文档中有效地展示内联代码和多行代码块，包括语法高亮、文件名显示和代码分组等高级功能。
---
...
使用内联代码在文本段落中嵌入简短的代码片段，非常适合在句子中直接引用代码元素。
...
使用代码块来展示带有语法高亮的多行代码。代码块对于清晰地呈现代码示例至关重要。
...
图标已默认定义，但您可以在 `app.config.ts` 中进行自定义：
