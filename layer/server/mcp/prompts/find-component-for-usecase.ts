...
export default defineMcpPrompt({
  description: 'Find the best component for a specific use case',
  inputSchema: {
      ...
      messages: [
        {
          ...
          content: {
            type: 'text' as const,
            text: `Help me find the best component for this use case: "${usecase}". Here are all available components: ${JSON.stringify(components, null, 2)}`
          }
        }
      ]
    }
